#!/usr/bin/bash
#SBATCH --job-name=ichor_pipeline_full_500kb
#SBATCH --nodes=1
...
#2. Ichor Prep
$hmm_util/readCounter --window 500000 \
--quality 20 \
...
Rscript $ichor/scripts/runIchorCNA.R --id $patient \
  ...
  --normalPanel $ichor/inst/extdata/HD_ULP_PoN_hg38_500kb_median_normAutosome_median.rds \
