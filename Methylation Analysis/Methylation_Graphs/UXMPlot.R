...
B78_24 <- read.csv("B78_24.uxm.csv")
B70_24 <- read.csv("B70_24.uxm.csv")
B123_25_ATHENA <- read.csv("B123_25_ATHENA.uxm.csv")
B168_24 <- read.csv("B168_24.uxm.csv")
B358_24 <- read.csv("B358_24.uxm.csv")
HC_78 <- read.csv("HC_78.uxm.csv")

#Fix column names of data frames
B78_24 <- rename(B78_24, B78_24 = B78_24_cleaned)
B70_24 <- rename(B70_24, B70_24 = B70_24_cleaned)
B123_25_ATHENA <- rename(B123_25_ATHENA, B123_25_ATHENA = B123_25_ATHENA_cleaned)
B168_24 <- rename(B168_24, B168_24 = B168_24_cleaned)
B358_24 <- rename(B358_24, B358_24 = B358_24_cleaned)
HC_78 <- rename(HC_78, HC_78 = HC_78_cleaned)
...
plot_data <- Reduce(function(x, y) left_join(x, y, by = "CellType"), df_list ) |>
  #Reshape data from wide to long format
  pivot_longer(cols = -CellType, names_to = "Patient", values_to = "Value") |> 
  #Change column x to more appropriate name
  rename(Tissue = CellType)
...
ggsave("UXM_Plot.png", plot = gg_plot, width = 25, height = 18, units = "cm", dpi = 900)